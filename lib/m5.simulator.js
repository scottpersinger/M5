...
M5.onTouchReady(function() {
  ...
  function loadBig() {
    ...
    if ($('#jqt').length > 0) {
      $('#jqt').css({width:(320), height:(480), 'margin-left' :'26px', 'margin-top': '77px', overflow:'hidden',float:'left'});
    } else {
      $('body > div:first').css({width:(320), height:(480), 'margin-left' :'27px', 'margin-top': '77px', overflow:'hidden',float:'left'});
